...
///////////////////////////////////////////////////////////////////////////
package widgets.supportClasses.components
{
	...
	import widgets.supportClasses.components.toc2.tocClasses.TocItem;
	import widgets.supportClasses.components.toc2.tocClasses.TocItemRenderer;
	import widgets.supportClasses.components.toc2.tocClasses.TocMapLayerItem;
	 ...
	 * @private
	 */
	public class TOC2 extends Tree
	{
		/**
		 ...
		 */
		public function TOC2(map:Map = null)
		{
			super();
		...
		[Bindable("includeLayerItemsChanged")]
		private var _includeLayerItems:Boolean = false;
		
		public function get includeLayerItems():Boolean
		{
			return _includeLayerItems;
		}
		
		public function set includeLayerItems(value:Boolean):void
		{
			if (value != _includeLayerItems)
			{
				_includeLayerItems = value;
				
				invalidateProperties();
				dispatchEvent(new Event("includeLayerItemsChanged"));
			}
		}
		...
		public function refreshTOCLayer(layer:Layer):void
		{
			this.unregisterMapLayer(layer);
			this.registerMapLayer(layer);
		}
		...
		public function filterOutLayer(layer:Layer):Boolean
		{
			...
			if (includeLayers)
			{
				/* 	Default include mode (false) will only show layers that are listed in the include list.  
				If set to true, a layer in the included list that has been excluded by a previously tested
				rule will override that rule and be included. */  
				if (_includeLayerItems == false)
				{
					exclude = true;
				}
