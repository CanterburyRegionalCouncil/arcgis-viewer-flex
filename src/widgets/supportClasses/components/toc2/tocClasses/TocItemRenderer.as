...
///////////////////////////////////////////////////////////////////////////
package widgets.supportClasses.components.toc2.tocClasses
{
	...
	import widgets.supportClasses.components.TOC2;
	...
	public class TocItemRenderer extends TreeItemRenderer
	{
		...
		override protected function commitProperties():void
		{
			...
			if (data is TocItem)
			{
				...
				if (!isLayerItem(item) || !TOC2(this.parent.parent).showLayerMenu)
				{
		...
		private function onLayerMenuImageClick(event:MouseEvent):void
		{
			...
			else
			{
				...
				_tocLayerMenu.popUpForItem(this.parent.parent, data, TOC2(this.parent.parent).map, globalPoint.x, globalPoint.y);
